...
- Building, project, colony, and research preset JSON editors now show per-field include checkboxes; unchecked fields are saved out of the preset so applying that preset leaves those attributes unchanged, and unchecked inputs remain visible but greyed/disabled.
