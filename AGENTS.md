...
- Advanced research now includes `White Dwarf Harvesting` (100T), unlocking repeatable tera `White Dwarf Harvesters`: expansion scales with terraformed worlds/Hephaestus yards, assigned harvesters are capped at `10B`, consume space energy at 20x Star Lifting's energy per ton, and process an assumed `1e37` total tons of carbon monoxide across the accessible 10B-white-dwarf pool over `10000 * 365` game seconds into space-storage graphite and oxygen at CO mass ratios.
