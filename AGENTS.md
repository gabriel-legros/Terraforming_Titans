...
### Difficulty Settings
- Difficulty settings include persisted multipliers for building costs, global research output, worker requirements, project duration, population growth, life growth, maintenance costs, spaceship energy costs before/after Space Elevator, Galaxy fleet capacity, and Galaxy threat scaling. Defaults are 1, building/project duration clamp to at least 0.01, and research/pop/life/maintenance/spaceship/Galaxy multipliers clamp to at least 0. Effects are applied through the shared effect system when settings change and during the normal manager effect reapply pass on load/travel.
