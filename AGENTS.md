...
- Hydrogen Import can target Atmosphere, Colony and Atmosphere, Colony and Space Storage, Colony only, or Space Storage. Colony and Atmosphere imports add colony hydrogen first and rely on colony hydrogen overflow to spill excess into atmospheric hydrogen; Colony and Space Storage fills colony hydrogen first and sends post-consumer overflow into space storage; Colony only stops at colony storage.
