...
### Difficulty Settings
- Difficulty settings include persisted multipliers for building costs, global research output, worker requirements, project duration, population growth, life growth, maintenance costs, spaceship energy costs before/after Space Elevator, advanced research gain, Galaxy fleet capacity, Galaxy threat scaling, and artificial world construction time. Defaults are 1, building/project duration and artificial world construction time clamp to at least 0.01, and research/pop/life/maintenance/spaceship/advanced research/Galaxy multipliers clamp to at least 0. Effects are applied through the shared effect system when settings change and during the normal manager effect reapply pass on load/travel.
