...
- Hazardous biomass growth now applies per-zone penalties, the Zone Growth summary uses a dedicated table, and Preferred Terrain shows the active preference with a tooltip explaining penalty math.
