...
- Aerostats include a saved and colony-preset-aware `Cap active and autobuild buildings to aerostat capacity` checkbox beside the worker cap; supported buildings are deactivated to their 100% aerostat support limit during the recurring set-active phase regardless of their auto-active setting, and autobuild cannot construct them above that limit.
