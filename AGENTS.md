...
- Script Automation adds a manually enabled top Automation-card script runner with dropdown-built conditions, expandable/condensed IF/WHILE/WAIT lines, GOTO, and one-shot application of building/project/colony/research presets and combinations; scripts persist through save/load and execute with per-tick WHILE/GOTO limits.
