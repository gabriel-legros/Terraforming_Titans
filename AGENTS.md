...
- Surface resources now include `liquidHydrogen` with zonal coverage, heat-capacity, localization support, and a mass-dependent effective density used by dynamic-mass geometry so giant hydrogen envelopes can stay physically plausible without needing a full hydrogen phase cycle yet.
