...
- `Space Chemistry Array` now also supports `Methane Combustion`, `Water Electrolysis`, and the oxygen-only `Silicates -> Oxygen` recipe, using the same stoichiometry as their ground-based chemistry counterparts where applicable.
