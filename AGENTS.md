...
- SMBH shellworlds save a lightweight per-world snapshot on departure and restore it on return. The snapshot keeps resource values, building/colony state, colony sliders, nanocolony settings, orbital allocation, resources/infrastructure project state plus Mega Heat Sink, and completed research; other mega/giga/tera project state is excluded.
