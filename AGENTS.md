...
- Olympus chapter `46.9` now unlocks story project `Self-improvement`, where electronics are spent in 100-unit batches to gain cores. Cores provide logarithmic industrial bonuses and threshold-based building/research-style unlocks.
