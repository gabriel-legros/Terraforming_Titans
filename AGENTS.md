...
- `Leviathans` is a `500Q` Steam/Electron-only advanced research that sets a Bioworld boolean flag, revealing an infinite Bioworld shop item with quadratic Evolution Point costs (`1, 4, 9, ...`). Purchases multiply available Followers orbitals by `1 + 0.01 * purchases`.
