...
- Galaxy faction control caches only rebuild when sector ownership changes, and the galaxy map now displays a shield icon with each sector's UHF defense strength.
