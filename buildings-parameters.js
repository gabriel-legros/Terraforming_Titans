const buildingsParameters = {
  ...
  waterPump: {
    ...
    consumption: { colony : {energy : 1}, surface: {liquidWater: 10 } },
  ...
  glassSmelter: {
    ...
    consumption: { colony: { energy: 50, silicon: 1} },
  ...
  componentFactory: {
    ...
    consumption: { colony: { energy: 2500, metal: 5} },
  ...
  electronicsFactory: {
    ...
    consumption: { colony: { energy: 5000, metal: 1, silicon: 4} },
  ...
  superconductorFactory: {
    ...
    consumption: { colony: { energy: 10000, metal: 1} },
  ...
  shipyard: {
    ...
    consumption: { colony: { energy: 10000, metal: 5, components: 1, electronics: 0.1} },
  ...
  nuclearPowerPlant: {
    ...
    production: { colony: { energy: 100000 }, atmospheric: {atmosphericWater: 50} },
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
    requiresMaintenance: true,
  ...
  fusionPowerPlant1: {
    ...
    consumption: { colony: { water: 0.1 } },
    production: { colony: { energy: 500000 }},
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
    requiresMaintenance: true,
  ...
  fusionPowerPlant2: {
    name: 'Modern Fusion Reactor',
    category: 'energy',
    description: 'A proper miniature star.',
    cost: { colony: { metal: 50000, components: 2500, electronics : 2500, superconductors : 1000 } },
    consumption: { colony: { water: 1 } },
    production: { colony: { energy: 2500000 }},
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
    requiresMaintenance: true,
