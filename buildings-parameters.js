const buildingsParameters = {
  ...
  nuclearPowerPlant: {
    ...
    production: { colony: { energy: 1000 }, atmospheric: {atmosphericWater: 5} },
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
    requiresMaintenance: true,
  ...
  fusionPowerPlant1: {
    ...
    cost: { colony: { metal: 2000, components: 100, electronics : 100, superconductors : 50 } },
    consumption: { colony: { water: 0.01 } },
    production: { colony: { energy: 5000 }},
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
    requiresMaintenance: true,
