const buildingsParameters = {
  ...
  componentFactory: {
    ...
    consumption: { colony: { energy: 500, metal: 5} },
  ...
  electronicsFactory: {
    ...
    consumption: { colony: { energy: 1000, metal: 1, silicon: 4} },
  ...
  androidFactory: {
    ...
    consumption: { colony: { energy: 1000, metal: 0.1, electronics: 0.1} },
  ...
  shipyard: {
    ...
    consumption: { colony: { energy: 1000, metal: 5, components: 1, electronics: 0.1} },
