(function () {
  ...
  const defaultPlanetResources = existingResources || {
    ...
    surface: {
      ...
      rocks: { coverageScale: 0.00001, name: '', initialValue: 0, unlocked: false, unit: 'ton', hideWhenSmall: true },
      graphite: { coverageScale: 0.001, name: '', initialValue: 0, unlocked: true, unit: 'ton', hideWhenSmall: true },
      scrapMetal : { coverageScale: 0.00002, name: '', initialValue : 0, unlocked: false, unit: 'ton', marginTop:10, reverseColor: true },
      garbage: { coverageScale: 0.0001, name: '', hasCap: false, initialValue: 0, unlocked: false, unit: 'ton', hideWhenSmall: true, reverseColor: true },
      trash: { coverageScale: 0.0002, name: '', hasCap: false, initialValue: 0, unlocked: false, unit: 'ton', hideWhenSmall: true, reverseColor: true },
      junk: { coverageScale: 0.00005, name: '', hasCap: false, initialValue: 0, unlocked: false, unit: 'ton', reverseColor: true },
      radioactiveWaste: { coverageScale: 0.00002, name: '', hasCap: false, initialValue: 0, unlocked: false, unit: 'ton', hideWhenSmall: true, reverseColor: true },
    },
    underground: {
      ...
      stellarMass: { name: '', initialValue: 0, hasCap: false, unlocked: false, unit: 'ton', showUndergroundRate: true, hideWhenSmall: true }
    },
    atmospheric: {
    ...
    spaceStorage: {
      ...
      food: { name: '', initialValue: 0, hasCap: false, unlocked: false, unit: 'packs' },
