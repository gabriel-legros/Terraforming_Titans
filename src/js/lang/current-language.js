  ...
  ui: {
    ...
    projects: {
      ...
      spaceStorage: {
        ...
        strategicReserveTooltip: 'Projects will avoid spending the specified strategic reserve amount. Withdrawals ignore this setting.',
      ...
      hazardsUi: {
        ...
        hazardousMachinery: {
          ...
          labels: {
            ...
            convertCost: 'Electronics Cost: {value}',
            convertAction: 'Hack +{value}',
            convertInfo: 'Each hack spends {cost} electronics to turn 1 hazardous machinery into 1 android instantly.',
            barSafe: 'Clear {value}%',
          ...
          tooltips: {
            ...
            hacking: 'Counter-hacking spends electronics to instantly claim hostile machinery as functional androids. If less machinery is available than the selected amount, electronics spending scales down automatically. The hacked units are rendered compatible with the Dead Hand Protocol.',
          },
          rateLabels: {
