setLanguageData({
  ...
  ui: {
    ...
    terraforming: {
      ...
      summaryUi: {
        ...
        lifeSummary: {
          ...
          thermodynamicsFluxTooltip: 'Solar energy stored as chemical energy by natural surface-life growth during the latest tick. Negative values represent cooling. Growth in each zone can absorb at most 10% of its surface solar flux, and this cooling changes that zone\'s temperature trend.',
    ...
    settings: {
      ...
      lifeThermodynamicsTooltip: 'When enabled, natural surface-life growth in each climate zone is limited by the chemical energy it can store from at most 10% of that zone\'s surface solar flux. The stored energy also provides direct cooling.',
