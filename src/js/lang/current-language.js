    ...
    terraforming: {
      ...
      summaryUi: {
        ...
        temperature: {
          ...
          coreHeatTooltip: [
            'Planetary interior heat added directly to the surface as a flat global flux. It transfers smoothly into stellar self-emission as fusion develops instead of being counted twice. A former star retains its last total intrinsic flux after returning to a brown-dwarf or planetary stage; only the portion not already represented by ongoing fusion appears here as remnant core heat.',
            '',
          ...
          fusionFluxTooltip: 'This is the world\'s own thermal self-emission, separate from the host star\'s solar flux. Planetary core heat transfers smoothly into this value as fusion develops; at star stage it represents the complete outward intrinsic flux, so core heat is not added again. It reflects the planetary, stellar, surface, and atmospheric resources currently incorporated into the stellar body. At star stage and beyond, Mega Heat Sinks cannot suppress this fusion flux or the body\'s remaining intrinsic core heat; they can still mitigate factory heat and accelerate ordinary cooling toward the temperature trend. The retained photosphere follows gravity and temperature-dependent opacity. Current photosphere: {temperature} K at {pressure}.',
