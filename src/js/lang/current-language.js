setLanguageData({
  ...
  ui: {
    ...
    settings: {
      ...
      saveStorageWarning: 'Some browsers (especially Brave) or aggressive ad blockers can prevent save to local storage or purge your saves on a restart.  Please be careful.  Alternative saving options (save to file and save to clipboard) are available.',
