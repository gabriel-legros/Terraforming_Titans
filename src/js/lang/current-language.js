setLanguageData({
  ...
  ui: {
    ...
    settings: {
      ...
      saveStorageWarning: 'Some browsers (especially Brave) or aggressive ad blockers can prevent save to local storage or purge your saves on a restart.  Please be careful.  Alternative saving option (save to file and save to clipboard) are available.',
  ...
  catalogs: {
    ...
    research: {
      ...
      advanced: {
        ...
        teleporters: {
          name: 'Teleporters',
          description: 'We cannot quite convert matter into energy and back, but we can very narrowly transport matter via the warp.  This should allow us to move items back and forth from space storage without using ships.  Energy-intensive.',
        },
        deep_warp_storage: {
