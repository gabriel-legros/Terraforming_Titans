    ...
    projects: {
      ...
      spaceMirrorFacility: {
        ...
        advanced: {
          ...
          titleTooltip: 'Unlocks target-based control: set temperature targets per zone and a water melt target. Mirrors and lanterns auto-assign by priority when enabled; lower numbers are assigned first.',
          ...
          targetsPriorityTooltip: 'Set temperature targets for each zone using the current unit, plus a water melt target when focusing. Priorities 1 to 5 decide assignment order; lower numbers are assigned first.',
          average: 'Average',
          day: 'Day',
          night: 'Night',
          meltRate: 'Melt (t/s)',
