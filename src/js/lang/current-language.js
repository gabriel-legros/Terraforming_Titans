    ...
    terraforming: {
      ...
      summaryUi: {
        ...
        temperature: {
          ...
          fusionFluxTooltip: 'This is the world\'s own thermal self-emission, separate from the host star\'s solar flux. It reflects the planetary, stellar, surface, and atmospheric resources currently incorporated into the stellar body. At star stage and beyond, Mega Heat Sinks cannot suppress this fusion flux or the body\'s remaining intrinsic core heat; they can still mitigate factory heat and accelerate ordinary cooling toward the temperature trend. The retained photosphere follows gravity and temperature-dependent opacity. Current photosphere: {temperature} K at {pressure}.',
