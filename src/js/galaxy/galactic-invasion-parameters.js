...
const PROMETHEAN_INVASION_OPERATION_MS = 9000;
const PROMETHEAN_INVASION_LAUNCH_COOLDOWN_MS = 1000;
const PROMETHEAN_INVASION_UHF_COMMAND_BYPASS_OPERATION_MS = 10000;
...
const GALACTIC_INVASION_REWARDS = {
  ...
  gammaUpper: [{ target: 'spaceManager', targetType: 'spaceManager', type: 'oneillSectorCapMultiplier', value: 1, effectId: 'galactic-invasion-gamma-upper-oneill-sector-cap', valueFormat: 'number', labelKey: 'ui.space.invasion.rewards.oneillSectorCap', labelFallback: 'O\'Neill Cap Multiplier +{value}' }],
  ...
  iotaUpper: [{ target: 'spaceManager', targetType: 'spaceManager', type: 'oneillSectorCapMultiplier', value: 2, effectId: 'galactic-invasion-iota-upper-oneill-sector-cap', valueFormat: 'number', labelKey: 'ui.space.invasion.rewards.oneillSectorCap', labelFallback: 'O\'Neill Cap Multiplier +{value}' }],
  ...
  muLower: [{ target: 'spaceManager', targetType: 'spaceManager', type: 'oneillSectorCapMultiplier', value: 2, effectId: 'galactic-invasion-mu-lower-oneill-sector-cap', valueFormat: 'number', labelKey: 'ui.space.invasion.rewards.oneillSectorCap', labelFallback: 'O\'Neill Cap Multiplier +{value}' }],
  ...
  piUpper: [{ target: 'spaceManager', targetType: 'spaceManager', type: 'oneillSectorCapMultiplier', value: 2, effectId: 'galactic-invasion-pi-upper-oneill-sector-cap', valueFormat: 'number', labelKey: 'ui.space.invasion.rewards.oneillSectorCap', labelFallback: 'O\'Neill Cap Multiplier +{value}' }],
  ...
  upsilonLower: [{ target: 'spaceManager', targetType: 'spaceManager', type: 'oneillSectorCapMultiplier', value: 2, effectId: 'galactic-invasion-upsilon-lower-oneill-sector-cap', valueFormat: 'number', labelKey: 'ui.space.invasion.rewards.oneillSectorCap', labelFallback: 'O\'Neill Cap Multiplier +{value}' }],
