...
const GALACTIC_INVASION_REWARDS = {
  ...
  upsilonUpper: [{ target: 'lifters', type: 'superchargeExponentReduction', value: 0.4000000000000002, valueFormat: 'number', labelKey: 'ui.space.invasion.rewards.liftersSuperchargeExponent', labelFallback: 'Lifters supercharge exponent -{value}' }],
