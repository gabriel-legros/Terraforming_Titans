var terraformingParameters = {
  ...
  geometry: {
    ...
    stellarEvolution: {
      ...
      lowMassStellarRadiusExponent: 0.9,
      highMassStellarRadiusExponent: 0.7443966064481344,
      stellarRadiusExponentBoundarySolar: 1,
      fusionThresholdTemperatureK: 2500,
      solarEffectiveTemperatureK: 5772,
      lowMassStellarTemperatureExponent: 0.32529344229725105,
      highMassStellarTemperatureExponent: 0.7373289897947748,
      stellarTemperatureExponentBoundarySolar: 1,
      photosphereOpticalDepth: 2 / 3,
      photosphereReferenceOpacityM2Kg: 0.015,
      photosphereReferenceTemperatureK: 5772,
      photosphereOpacityTemperatureExponent: 0.5,
      photosphereMinimumOpacityTemperatureK: 500,
      photospherePressureRangePa: { minimum: 100, maximum: 1e7 },
      photosphereElements: {
  ...
  climate: {
    ...
    surfaceModel: {
      biomassMaximum: 0.75,
      excludedResources: ['land', 'hazardousBiomass', 'hazardousMachinery', 'scrapMetal', 'garbage', 'trash', 'junk', 'radioactiveWaste'],
