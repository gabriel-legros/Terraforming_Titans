...
function initializeHazardousBiomassUI() {
  ensureLayout();
}
...
try {
  window.initializeHazardousBiomassUI = initializeHazardousBiomassUI;
  window.updateHazardousBiomassUI = updateHazardousBiomassUI;
} catch (error) {
...
try {
  if (module && module.exports) {
    module.exports = {
      initializeHazardousBiomassUI,
      updateHazardousBiomassUI
    };
  }
} catch (error) {
