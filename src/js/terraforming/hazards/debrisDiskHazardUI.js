...
function updateDebrisDiskHazardUI(debrisDiskParameters) {
  ...
  const effects = [
    ...
    getDebrisDiskHazardText('effectsList.kesslerRegeneration', 'If Kessler Skies is also active, Debris Disk regenerates orbital debris by {value}% of each Kessler bin per second.', { value: formatNumber((debrisDiskParameters.kesslerRegenerationRatePerBinPerSecond ?? 0.001) * 100, false, 2) }),
