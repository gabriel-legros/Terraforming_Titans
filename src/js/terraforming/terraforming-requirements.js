...
const terraformingRequirements = {
  ...
  oommaa: {
    ...
    totalPressureRangeKPa: { min: 5000, max: 9000 },
    gasTargetsPa: {
  ...
  vanadophore: {
    ...
    lifeDesign: {
      ...
      growthTemperatureTolerancePerPointC: 10,
      photosynthesisRatePerPoint: 0.00001,
      bioworkersPerBiomassPerPoint: 0.00001,
  ...
  yggies: {
    ...
    gasTargetsPa: {
      carbonDioxide: { min: 100_000, max: 200_000 },
      oxygen: { min: 1_000_000, max: 2_000_000 },
      inertGas: { min: 2_000_000, max: 3_000_000 },
      atmosphericAmmonia: { min: 0, max: 10 },
    },
