...
progressTartarus.chapters.push(
  ...
  },
  {
    ...
    chapter: 30,
    activePlanet: 'tartarus',
    narrative: "Solis : 'Sorry for the interruption!  I could not help but notice...  Mister Prometheus... you have some very nice machinery over there.  If I could just have a sample...'  \n $PROMETHEUS$ : 'The insect is interrupting this important conversation.  You have been withholding some upgrades, haven't you?  You know...  I'll give these useless trinkets to the child.  If you want them, you'll have to *buy it* from it.' \n Solis : 'Alright.  Hrmm.  HOPE!  My team have come up with some new automation software just for you!  Also, we came up with an android design that will survive an ANY world.  I think you'd like that.  (whisper) I really want those trinkets.' \nSystem Message : 100 alien artifacts received from Prometheus.  New upgrades available from Solis Corp.",
