const buildingsParameters = {
  ...
  junkRecycler: {
    name: 'Junk Recycler',
    category: 'waste',
    description: 'Recycles junk into electronics using silicon, metal, and energy.',
    cost: { colony: { metal: 500, components: 50, electronics: 25 } },
    consumption: { colony: { energy: 10000000, silicon: 2, metal: 0.5 }, surface: { junk: 10 } },
    production: { colony: { electronics: 10 } },
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
    requiresMaintenance: true,
  ...
  scrapRecycler: {
    ...
    consumption: { colony: { energy: 5000000 }, surface: { scrapMetal: 10 } },
  ...
  radioactiveRecycler: {
    ...
    consumption: { colony: { androids: 10 }, surface: { radioactiveWaste: 10 } },
    production: { colony: { metal: 10 } },
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
