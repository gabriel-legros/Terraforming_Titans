const buildingsParameters = {
  ...
  junkRecycler: {
    name: 'Junk Recycler',
    category: 'waste',
    description: 'Recycles junk into electronics using silicon, electronics, and energy.',
    cost: { colony: { metal: 500, components: 50, electronics: 25 } },
    consumption: { colony: { energy: 10000000, silicon: 2, electronics: 0.5 }, surface: { junk: 10 } },
    production: { colony: { electronics: 1 } },
    storage: {},
    dayNightActivity: false,
    canBeToggled: true,
