...
class SolisManager extends EffectableEntity {
  constructor(resourceValues = {}) {
    ...
    this.shopUpgrades = {
      ...
      researchAutomation: { baseCost: 1500, purchases: 0, max: 1, enabled: false },
  ...
  applyBooleanFlag(effect) {
    ...
    } else if (effect.flagId === 'solisResearchAutomation') {
      this.setUpgradeEnabled('researchAutomation', !!effect.value);
  ...
  purchaseUpgrade(key) {
    ...
    if (key === 'funding' && typeof addEffect === 'function') {
    ...
    } else if (key === 'researchAutomation' && typeof addEffect === 'function') {
      addEffect({
      ...
      addEffect({
        target: 'automationManager',
        type: 'booleanFlag',
        flagId: 'automationResearch',
        value: true,
        effectId: 'solisAutomationResearch',
        sourceId: 'solisShop'
      });
    ...
    } else if (key === 'projectsAutomation') {
      addEffect({
        target: 'automationManager',
        type: 'enable',
        effectId: 'solisAutomationEnable',
    ...
    } else if (key === 'automationScripting') {
      addEffect({
        target: 'automationManager',
        type: 'enable',
        effectId: 'solisAutomationEnable',
  ...
  reapplyEffects() {
    ...
    const researchAutomationUpgrade = this.shopUpgrades.researchAutomation;
    if (researchAutomationUpgrade && researchAutomationUpgrade.purchases > 0 && typeof addEffect === 'function') {
      addEffect({
        target: 'automationManager',
        type: 'enable',
        effectId: 'solisAutomationEnable',
    ...
    const projectsAutomationUpgrade = this.shopUpgrades.projectsAutomation;
    if (projectsAutomationUpgrade && projectsAutomationUpgrade.purchases > 0) {
      addEffect({
        target: 'automationManager',
        type: 'enable',
        effectId: 'solisAutomationEnable',
    ...
    const automationScriptingUpgrade = this.shopUpgrades.automationScripting;
    if (automationScriptingUpgrade && automationScriptingUpgrade.purchases > 0) {
      addEffect({
        target: 'automationManager',
        type: 'enable',
        effectId: 'solisAutomationEnable',
