...
if (typeof progressSolisPrime === 'undefined') {
  if (typeof module !== 'undefined') {
    try { progressSolisPrime = require('./story/solisPrime.js'); } catch (e) {}
  }
}
if (typeof progressGabbag === 'undefined') {
  if (typeof module !== 'undefined') {
    try { progressGabbag = require('./story/gabbag.js'); } catch (e) {}
  }
}
if (typeof progressPoseidon === 'undefined') {
  if (typeof module !== 'undefined') {
    try { progressPoseidon = require('./story/poseidon.js'); } catch (e) {}
  }
}
try { progressTartarus = require('./story/tartarus.js'); } catch (e) {}
try { progressHades = require('./story/hades.js'); } catch (e) {}
try { progressStyx = require('./story/styx.js'); } catch (e) {}
try { progressZeus = require('./story/zeus.js'); } catch (e) {}
...
mergeProgress(progressStyx);
mergeProgress(progressZeus);
