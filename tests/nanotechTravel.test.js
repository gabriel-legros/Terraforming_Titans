...
describe('Nanotech travel preservation', () => {
  test('nanobots capped at 1e15 across travel', () => {
    ...
    vm.runInContext('nanotechManager.nanobots = 2e15;', ctx);

    vm.runInContext("selectPlanet('titan');", ctx);

    const bots = vm.runInContext('nanotechManager.nanobots', ctx);
